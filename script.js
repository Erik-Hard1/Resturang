function showMenu(){
    ...
    if(button.style.gridTemplateRows === "70px" ){
        button.style.gridTemplateRows = "5px";  
        for(let i = 0; i < opacity.length; i++){
        opacity[i].style.opacity = 0;
    }
    }
    else{
        button.style.gridTemplateRows = "70px"; 
        
    for(let i = 0; i < opacity.length; i++){
        opacity[i].style.opacity = 1.0;
    }
